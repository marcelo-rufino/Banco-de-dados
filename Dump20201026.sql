CREATE DATABASE  IF NOT EXISTS `influenciadosgames` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `influenciadosgames`;
...
CREATE TABLE `tabela_de_produtos` (
  ...
  `Nome da Imagem` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`idtabela_de_produtos`),
  UNIQUE KEY `Nome da Imagem_UNIQUE` (`Nome da Imagem`)
...
INSERT INTO `tabela_de_produtos` VALUES (1,'Videogame','Nintendo Switch Azul e Vermelho',3400.00,'imagens/Console%20NSwitch.png'),(2,'Videogame','PlayStation 4 1TB + Controle',2990.00,'imagens/Console%20PS4.png'),(3,'Videogame','Xbox One 1TB + Controle',2499.00,'imagens/Console%20Xbox.png'),(4,'Controle','Controle PlayStation 4 - Preto - Sem fio',219.00,'imagens/Controle%20PS4.png'),(5,'Controle','Controle Xbox One - Preto - Sem fio',400.00,'imagens/controle%20xbox.png'),(6,'Jogo','Jogo Injustice 2 - PlayStation 4',89.00,'imagens/Injustice%202%20PS4.png'),(7,'Jogo','Jogo GTA V - Xbox One',149.00,'imagens/GTA%20Xbox.png'),(8,'Jogo','Jogo Mario Kart - Nintendo Switch',360.00,'imagens/Mario%20Kart%20NSwitch.png'),(9,'Fone','Headset Gamer Warrior Straton',269.00,'imagens/Headset%20gamer.png'),(10,'Teclado','Teclado Mecânico Redragon',250.00,'imagens/Teclado%20mec%C3%A2nico.png'),(11,'Mouse','Mouse Gamer Logitech',190.00,'imagens/mouse%20gamer.png'),(12,'Monitor','Monitor Gamer Ultrawide Curvo 49\" Asus',9800.00,'imagens/monitor%20gamer.png');
...
-- Dump completed on 2020-10-26 23:04:10
